...
const App =()=> {
  ...
  const [progress, setProgress] = useState(0)
    ...
    return (
      ...
      />
          <Switch>
          <Route exact path="/"><News setProgress={setProgress} apiKey={apiKey} key="genral" pageSize={pageSize} country="in" category="general" /></Route>
            <Route exact path="/business"><News setProgress={setProgress} apiKey={apiKey} key="busines" pageSize={pageSize} country="in" category="business" /></Route>
